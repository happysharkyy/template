...
public class FileUploadController {
        private final String path="/home/image/uploadFile/";
        @Autowired
        ...
        public ApiResult<String> avatarUpload(@RequestParam("picFile") MultipartFile picture, HttpServletRequest request, @PathVariable String userName) throws IOException {
            ...
            try {
                ...
                targetFile.deleteOnExit(); // 令临时文件在JVM关闭的时候自动删除
                targetFile.delete(); // 立刻删除临时文件
    ...
    public ApiResult getImageAll() {
        return ApiResult.success(sysFileService.list());
    }
    @DeleteMapping("/delete/{id}")
    public ApiResult<Boolean> delete(@PathVariable("id") String id) {
        return ApiResult.success(sysFileService.removeById(id));
    }
}
