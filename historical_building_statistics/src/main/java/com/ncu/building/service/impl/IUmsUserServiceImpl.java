...
import com.ncu.building.common.exception.ApiAsserts;
import com.ncu.building.common.security.util.JwtTokenUtil;

import com.ncu.building.mapper.SysRoleMapper;
import com.ncu.building.mapper.SysUserMapper;
import com.ncu.building.model.dto.LoginDTO;
import com.ncu.building.model.dto.RegisterDTO;
import com.ncu.building.model.entity.*;
...
public class IUmsUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements IUmsUserService{
    ...
    public SysUser executeRegister(RegisterDTO dto) {
        ...
        SysUser addUser = SysUser.builder()
                ...
                .alias(dto.getName())
                .avatar("/image/avatar/2021-04-30/1.jpg")
