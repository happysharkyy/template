<template>
  <el-form :model="loginForm" :rules="fieldRules" ref="loginForm" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <el-form-item label="记住" label-width="40" align="left">
...
export default {
  ...
  methods: {
    login() {
      this.loading = true
      let userInfo = {username:this.loginForm.account, password:this.loginForm.password,rememberMe:this.loginForm.rememberMe}
      this.$api.login.login(userInfo).then((res) => {
          if(res.code != 200) {
            ...
            sessionStorage.setItem('avatar', res.data.avatar) // 保存用户到本地会话
